...
export const STD_DRINK_MODIFIERS = [
  {
...
export const RECIPES: Record<string, { invId: string; qty: number }[]> = {
  m1: [
  ...
  m11: [{ invId: 'inv-croissant', qty: 1 }],
  m12: [{ invId: 'inv-brownie',   qty: 1 }],
  m13: [{ invId: 'inv-cookie',    qty: 1 }],
  m14: [{ invId: 'inv-cheese',    qty: 1 }],
  m15: [],
  m16: [
